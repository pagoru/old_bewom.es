	...
	<div class="absolute-inside-box">
		...
		<div class="absolute-form">
			<form action="<?php echo $urlPost;?>" method="post">
				<select name="icon" style="width: 196px;" class="input-absolute-title">
					<?php foreach ($pokemonList as $poke):?>
					<option value="<?php echo $poke;?>"><?php echo $poke;?></option>
					<?php endforeach;?>
				</select>
				<input name="title" style="width: 439px;" class="input-absolute-title" value="Nombre del tema"></input>
